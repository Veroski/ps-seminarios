...
export default function StudentCoursePage() {
  ...
  useEffect(() => { if (formation && profile && !hasPurchased(profile, formation.id)) navigate(studentAreaConfig.coursesPath, { replace: true }); }, [formation, navigate, profile]);
