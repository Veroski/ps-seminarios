...
export default function StudentCoursesPage() {
  ...
  return (
    <StudentShell>
      <Seo title="Mis formaciones | Área de alumnas Patricia Songel" description="Accede a tus formaciones de Patricia Songel." canonical="https://www.patriciasongel.es/alumnos/formaciones" robots="noindex, nofollow" />
