    ...
    <div className="min-h-[100svh] bg-[#F1EDED]">
      ...
      <div className="border-b border-[#0A0A0A]/8 bg-[#F1EDED]/90 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-6 md:px-12 h-16 flex items-center justify-between">
          ...
          <span className="font-mono text-xs text-[#0A0A0A]/30" style={{ letterSpacing: '0.06em' }}>SEMINARIOS / TÉRMINOS</span>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 py-24">
        ...
        <div className="mb-20 border-b border-[#0A0A0A]/10 pb-16">
          <p className="font-mono text-xs text-[#0A0A0A] mb-6 tracking-widest uppercase" style={{ letterSpacing: '0.24em' }}>03 — Legal</p>
          <h1 className="font-serif italic text-5xl md:text-6xl text-[#0A0A0A] mb-4" style={{ letterSpacing: '-0.02em' }}>Términos y<br />Condiciones</h1>
          <p className="font-sans text-sm text-[#262222]/50 mt-4" style={{ letterSpacing: '-0.01em' }}>Última actualización: marzo 2026</p>
        </div>
