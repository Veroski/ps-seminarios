...
export default function Philosophy() {
  ...
  return (
    <section
      id="philosophy"
      ref={sectionRef}
      className="relative w-full py-20 md:py-32 overflow-hidden bg-[#0A0A0A] text-[#F3EDE2] scroll-mt-32"
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        {/* Brand Monogram "PS" */}
        <div className="bg-char absolute right-0 top-1/2 -translate-y-1/2 font-serif italic font-bold select-none pointer-events-none leading-none text-[#F3EDE2]/[0.04]"
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        {particles.map((style, i) => (
          <div
            key={i}
            className="gold-dust absolute rounded-full bg-[#F3EDE2]/30 blur-[1px]"
      ...
      <div className="relative z-10 w-full max-w-6xl px-6 md:px-10 xl:px-12 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="phi-header flex flex-col gap-8">
          {/* Eyebrow */}
          <span className="text-overline text-[#F3EDE2]/68">Filosofía de Trabajo</span>

          {/* Main title */}
          <h2 className="font-serif italic text-5xl md:text-6xl xl:text-7xl text-[#F3EDE2] leading-[0.88] tracking-tight">
            La Belleza<br />
            de la <span className="text-[#F3EDE2]">Responsabilidad.</span>
          </h2>
          ...
          <ul className="flex flex-col gap-4">
            {[
              ...
              <li key={i} className="flex items-start gap-3">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-[#F3EDE2]/70 flex-shrink-0" />
                <span className="font-sans text-sm md:text-base text-[#F3EDE2]/72 leading-relaxed tracking-[-0.01em]">{item}</span>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-10">
          <p ref={el => { textRefs.current[0] = el; }} className="font-serif italic text-2xl md:text-3xl text-[#F3EDE2]/92 leading-tight">
          ...
          <blockquote ref={el => { textRefs.current[2] = el; }} className="border-l border-[#0A0A0A]/30 pl-5">
            <p className="font-serif italic text-lg md:text-xl text-[#F3EDE2]/55 leading-snug">
          ...
          <p ref={el => { textRefs.current[3] = el; }} className="text-overline-soft text-[#F3EDE2]/40">
