      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start gap-16 mb-24 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 sm:gap-12 font-sans text-sm w-full md:w-auto">
          <div className="flex flex-col gap-4">
            ...
            <a href="/#autoridad" className="hover:text-surface transition-colors">Autoridad</a>
            <a href="/#programa" className="hover:text-surface transition-colors">Programa</a>
            <a href="/#formaciones" className="hover:text-surface transition-colors">Formaciones</a>
          </div>
          <div className="flex flex-col gap-4">
