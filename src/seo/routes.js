...
export const routes = [
  ...
  },
  {
    ...
    image: img('/course-4-tecnicas-horizontal.webp'),
    robots: 'index, follow',
  },
  {
  ...
  },
  {
    ...
    image: img('/course-glowlips-horizontal.webp'),
    robots: 'index, follow',
  },
  {
    ...
    image: img('/course-hairstrokes-horizontal.webp'),
    robots: 'index, follow',
  },
  {
    path: '/formacion/cejas-online',
    title: 'Cejas Online · Lista de espera | Patricia Songel',
    description: 'Las plazas de Cejas Online están completas. Apúntate a la lista de espera para recibir aviso cuando abramos nuevas plazas.',
    image: img('/course-hairstrokes-horizontal.webp'),
    robots: 'index, follow',
  },
  {
    path: '/formacion/labios-online',
    title: 'Labios Online · Lista de espera | Patricia Songel',
    description: 'Las plazas de Labios Online están completas. Apúntate a la lista de espera para recibir aviso cuando abramos nuevas plazas.',
    image: img('/course-glowlips-horizontal.webp'),
    robots: 'index, follow',
  },
  {
