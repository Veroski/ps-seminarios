...
export const routes = [
  ...
  },
  {
    ...
    title: 'Brows Shadow Online · Lista de espera | Patricia Songel',
    description: 'Las plazas de Brows Shadow Online están completas. Apúntate a la lista de espera para recibir aviso cuando abramos nuevas plazas.',
    image: img('/brows_shadow_online_banner.webp'),
    robots: 'index, follow',
  },
  {
    path: '/formacion/labios-online',
    title: 'Glow Lips Online · Lista de espera | Patricia Songel',
    description: 'Las plazas de Glow Lips Online están completas. Apúntate a la lista de espera para recibir aviso cuando abramos nuevas plazas.',
